...
class UserProfileHeader: UICollectionViewCell {
    ...
    var user: User? {
        didSet {
            guard let profieImageUrl = user?.profileImageUrl else {return}
            profileImageView.loadImage(urlString: profieImageUrl)
    ...
    @objc func handleEditProfileOrFollow(){
        print("Execute edit profile / follow / unfllow")
    ...
    let postsLable: UILabel = {
        ...
        attributedText.append(NSMutableAttributedString(string: "posts", attributes: [NSAttributedStringKey.foregroundColor: UIColor.lightGray, NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14)]))
    ...
    override init(frame: CGRect) {
       ...
       editProfileFollowButton.anchor(top: postsLable.bottomAnchor, left: postsLable.leftAnchor, bottom: nil, right: followingLable.rightAnchor, paddingTop: 2, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 34)
    }
    ...
    fileprivate func setupBottomToolbar(){
        ...
        stackView.anchor(top: nil, left: leftAnchor, bottom: self.bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 59)
